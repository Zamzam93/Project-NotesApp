...
const noteContainer = document.getElementById("note-noteContainer"")
...
for (let i in c){
 document.cookie=/[^=]+/.exec(c[i])[0]+"=;express=Thur, 01 Jan 1970 00:00:00 GMT"}
 }
const handleSubmit(){
e.preventDefault()
let bodyObj = {
body.getElementById(note-input).value
 }
